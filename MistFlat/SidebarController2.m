...
- (void)viewDidLoad
{
    ...
    self.profileLocationLabel.text = @"中国, 北京";
    ...
    NSDictionary* object2 = [NSDictionary dictionaryWithObjects:@[ @"设备", @"4", @"check" ] forKeys:@[ @"title", @"count", @"icon" ]];
    NSDictionary* object3 = [NSDictionary dictionaryWithObjects:@[ @"账户", @"0", @"account" ] forKeys:@[ @"title", @"count", @"icon" ]];
    NSDictionary* object4 = [NSDictionary dictionaryWithObjects:@[ @"设置", @"0", @"settings" ] forKeys:@[ @"title", @"count", @"icon" ]];
    NSDictionary* object5 = [NSDictionary dictionaryWithObjects:@[ @"注销", @"0", @"arrow" ] forKeys:@[ @"title", @"count", @"icon" ]];
...
- (void)tableView:(UITableView *)tableView didSelectRowAtIndexPath:(NSIndexPath *)indexPath{
    ...
    switch (indexPath.row) {
        case 0:
            self.sidePanelController.centerPanel = [self.storyboard instantiateViewControllerWithIdentifier:@"homeViewController"];
            break;
        case 1:
