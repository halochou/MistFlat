...
- (void)viewDidLoad
{
    ...
    NSMutableDictionary *itemOne = [@{ kTitleKey : @"在指定时间开启或停止",
                                       kDetailKey: @"开启" } mutableCopy];
    NSMutableDictionary *itemTwo = [@{ kTitleKey : @"开始时间",
                                       kDateKey : [NSDate date] } mutableCopy];
    NSMutableDictionary *itemThree = [@{ kTitleKey : @"停止时间",
                                        kDateKey : [NSDate date] } mutableCopy];
    NSMutableDictionary *itemFour = [@{ kTitleKey : @"当前功率",
                                        kDetailKey: @"125W" } mutableCopy];
    NSMutableDictionary *itemFive = [@{ kTitleKey : @"累计耗电",
                                        kDetailKey: @"20 kWH" } mutableCopy];
...
- (UITableViewCell *)tableView:(UITableView *)tableView cellForRowAtIndexPath:(NSIndexPath *)indexPath
{
    ...
    else if ([cellID isEqualToString:kOtherCell])
    {
        ...
        //
        cell.textLabel.text = [itemData valueForKey:kTitleKey];
        cell.detailTextLabel.text = [itemData valueForKey:kDetailKey];
    }
